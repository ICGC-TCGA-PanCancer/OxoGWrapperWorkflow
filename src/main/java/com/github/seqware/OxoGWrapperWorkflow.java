...
public class OxoGWrapperWorkflow extends AbstractWorkflowDataModel {
	...
	public void buildWorkflow() {
		try {
			...
			Job combineVCFsByType = this.combineVCFsByType( sangerVCFJob, dkfzEmblVCFJob, broadVCFJob, normalBamJob, tumourBamJob);
			
			// indicate job is running.
			Job move2running = GitUtils.gitMove( "queued-jobs", "running-jobs", this.getWorkflow(), this.JSONlocation, this.JSONrepoName, this.JSONfolderName, this.GITname, this.GITemail, this.gitMoveTestMode, this.JSONfileName , combineVCFsByType);
