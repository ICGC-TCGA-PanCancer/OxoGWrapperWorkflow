...
class GitUtils {
	 ...
	 * @return
	 */
	static Job pullRepo(Workflow workflow, String GITPemFile, String GITname, String JSONrepo, String JSONrepoName, String JSONlocation, String GITemail) {
	...
	/**
	 * 	 * Moves file "this.JSONfileName" from one local directory in a git repo to another directory, and then commits the change 
	 ...
	 * @param JSONfileName
	 * @param parents A list of parent jobs for this job.
	 * @return
	 * @throws Exception
	 */
	static Job gitMove(String src, String dst,  Workflow workflow, String JSONlocation, String JSONrepoName, String JSONfolderName, String GITname, String GITemail, boolean gitMoveTestMode, String JSONfileName, Job ...parents) throws Exception {
